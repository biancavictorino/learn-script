...
const Learners = () => {
  ...
  return (
    <div className='px-8 py-16 lg:px-20 lg:pt-36 flex flex-col items-center overflow-hidden'>
        ...
        <div className='flex flex-col items-center justify-center gap-6 lg:flex-row lg:w-3/4 lg:pt-6' data-aos='fade-up'>
            {
                Learner.map(person => (
