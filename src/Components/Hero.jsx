  ...
  return (
    <div className='px-8 h-screen flex flex-col-reverse justify-center md:flex-row md:px-20 md:gap-20'>
        <div className='flex flex-col items-start justify-center gap-2 md:w-3/5 md:gap-4'>
            ...
            <p className='text-sm font-light leading-6 pb-3 md:text-md md:leading-7 md:text-lg md:font-extralight '>One-stop shop to learn the language of the digital world - coding! Whether you're a complete beginner or a seasoned programmer looking to expand your skillset, we have something for everyone.</p>
